...
const mockBorrowRequests = [
  ...
  { id: 'req_5', itemId: 'item_0', borrowerId: 'user_1', startDate: '2026-08-05', endDate: '2026-08-10', purpose: 'Home movie marathon with family.', message: 'Hey XYZ, requesting the projector for a few days.', status: 'Approved', createdAt: '2026-08-03', totalCost: 1750, securityDeposit: 3000 }
];
...
async function main() {
  ...
  print('Seeding complete! Database populated.');
}
